...
# --- Updated Imports for Free Embeddings ---
...
class RAGHelper:
    ...
    def __init__(self, collection_name: str = "study_materials", persist_directory: str = "./chroma_db"):
        ...
        # --- CHANGED: Use HuggingFace Embeddings (Free, Local) ---
        # This uses the 'all-MiniLM-L6-v2' model which is small, fast, and effective.
